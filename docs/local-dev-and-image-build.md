# Local dev loop and the image build

Moved out of CLAUDE.md (too big to load every turn). CLAUDE.md keeps the commands and the rules that bite; the reasoning and history live here.
